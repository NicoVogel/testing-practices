...
import { createPlantUmlImage } from '../plantuml/plugin';
...
const Plugin = {
  ...
  highlightBlock: function (block) {
    ...
    if (block.classList.contains('language-plantuml')) {
      const img = createPlantUmlImage(block);
      [...block.classList].filter(x => x !== 'language-plantuml').forEach(x => img.classList.add(x))
